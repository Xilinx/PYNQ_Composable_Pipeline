...
proc create_hier_cell_composable { parentCell nameHier } {
  ...
  connect_bd_net -net net_zynq_us_ss_soft_reset [get_bd_pins ps_user_soft_reset/peripheral_aresetn] [get_bd_pins axis_data_fifo_join_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_join_1/s_axis_aresetn] [get_bd_pins axis_downconv_join_0/aresetn] [get_bd_pins axis_downconv_join_1/aresetn] [get_bd_pins axis_upconv_join_0/aresetn] [get_bd_pins axis_upconv_join_1/aresetn] [get_bd_pins colorthresholding_accel/ap_rst_n] [get_bd_pins dfx_decouplers/soft_rst_n] [get_bd_pins filter2d_accel/ap_rst_n] [get_bd_pins gray2rgb_accel/ap_rst_n] [get_bd_pins lut_accel/ap_rst_n] [get_bd_pins pr_0/clk_300MHz_aresetn] [get_bd_pins pr_1/clk_300MHz_aresetn] [get_bd_pins pr_fork/clk_300MHz_aresetn] [get_bd_pins pr_join/clk_300MHz_aresetn] [get_bd_pins rgb2gray_accel/ap_rst_n] [get_bd_pins rgb2hsv_accel/ap_rst_n]
...
connect_bd_net [get_bd_ports clk_300MHz] [get_bd_pins fast_accel/ap_clk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins asr/aclk]
connect_bd_net [get_bd_ports clk_300MHz_aresetn] [get_bd_pins fast_accel/ap_rst_n] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins asr/aresetn]
...
connect_bd_net [get_bd_ports clk_300MHz] [get_bd_pins filter2d_accel/ap_clk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins asr/aclk]
connect_bd_net [get_bd_ports clk_300MHz_aresetn] [get_bd_pins filter2d_accel/ap_rst_n] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins asr/aresetn]
connect_bd_intf_net [get_bd_intf_ports stream_in1] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
connect_bd_intf_net [get_bd_intf_ports stream_out1] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
assign_bd_address
...
connect_bd_net [get_bd_ports clk_300MHz] [get_bd_pins cornerHarris_accel/ap_clk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins asr/aclk]
connect_bd_net [get_bd_ports clk_300MHz_aresetn] [get_bd_pins cornerHarris_accel/ap_rst_n] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins asr/aresetn]
connect_bd_intf_net [get_bd_intf_ports stream_in1] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
connect_bd_intf_net [get_bd_intf_ports stream_out1] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
assign_bd_address
...
connect_bd_net [get_bd_ports clk_300MHz] [get_bd_pins absdiff_accel/ap_clk] [get_bd_pins asr/aclk]
connect_bd_net [get_bd_ports clk_300MHz_aresetn] [get_bd_pins absdiff_accel/ap_rst_n] [get_bd_pins asr/aresetn]
assign_bd_address
set_property range 32K [get_bd_addr_segs {s_axi_control/SEG_absdiff_accel_Reg}]
validate_bd_design
save_bd_design
current_bd_design [get_bd_designs ${design_name}]
validate_bd_design
...
connect_bd_net [get_bd_ports clk_300MHz] [get_bd_pins add_accel/ap_clk] [get_bd_pins asr/aclk]
connect_bd_net [get_bd_ports clk_300MHz_aresetn] [get_bd_pins add_accel/ap_rst_n] [get_bd_pins asr/aresetn]
assign_bd_address
set_property range 32K [get_bd_addr_segs {s_axi_control/SEG_add_accel_Reg}]
validate_bd_design
save_bd_design
current_bd_design [get_bd_designs ${design_name}]
validate_bd_design
...
connect_bd_net [get_bd_ports clk_300MHz] [get_bd_pins bitwise_and_accel/ap_clk] [get_bd_pins asr/aclk]
connect_bd_net [get_bd_ports clk_300MHz_aresetn] [get_bd_pins bitwise_and_accel/ap_rst_n] [get_bd_pins asr/aresetn]
assign_bd_address
set_property range 32K [get_bd_addr_segs {s_axi_control/SEG_bitwise_and_accel_Reg}]
validate_bd_design
save_bd_design
...
connect_bd_net [get_bd_ports clk_300MHz] [get_bd_pins rgb2xyz_accel/ap_clk] [get_bd_pins asr/aclk]
connect_bd_net [get_bd_ports clk_300MHz_aresetn] [get_bd_pins rgb2xyz_accel/ap_rst_n] [get_bd_pins asr/aresetn]
assign_bd_address
