...
#
# 4.10  mr   06/10/2022 Replace duplicate IP with AXI4-Stream broadcaster
#
# </pre>
#
###############################################################################
...
proc create_hier_cell_composable { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_switch_M09_AXIS [get_bd_intf_pins axis_switch/M09_AXIS] [get_bd_intf_pins duplicate_accel/S_AXIS]
  ...
  connect_bd_intf_net -intf_net duplicate_accel_stream_out0 [get_bd_intf_pins axis_upconv_path_0/S_AXIS] [get_bd_intf_pins duplicate_accel/M00_AXIS]
  connect_bd_intf_net -intf_net duplicate_accel_stream_out1 [get_bd_intf_pins axis_upconv_path_1/S_AXIS] [get_bd_intf_pins duplicate_accel/M01_AXIS]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins clk_300MHz] [get_bd_pins axis_data_fifo_path_0/s_axis_aclk] [get_bd_pins axis_data_fifo_path_1/s_axis_aclk] [get_bd_pins axis_data_fifo_tx_path/s_axis_aclk] [get_bd_pins axis_downconv_path_0/aclk] [get_bd_pins axis_downconv_path_1/aclk] [get_bd_pins axis_switch/aclk] [get_bd_pins axis_switch/s_axi_ctrl_aclk] [get_bd_pins axis_upconv_path_0/aclk] [get_bd_pins axis_upconv_path_1/aclk] [get_bd_pins axis_upconv_tx_path/aclk] [get_bd_pins colorthresholding_accel/ap_clk] [get_bd_pins dfx_decouplers/clk_300MHz] [get_bd_pins filter2d_accel/ap_clk] [get_bd_pins gray2rgb_accel/ap_clk] [get_bd_pins lut_accel/ap_clk] [get_bd_pins duplicate_accel/aclk] [get_bd_pins pipeline_control/s_axi_aclk] [get_bd_pins pr_0/clk_300MHz] [get_bd_pins pr_1/clk_300MHz] [get_bd_pins pr_2/clk_300MHz] [get_bd_pins ps_user_soft_reset/slowest_sync_clk] [get_bd_pins rgb2gray_accel/ap_clk] [get_bd_pins rgb2hsv_accel/ap_clk] [get_bd_pins smartconnect/aclk] [get_bd_pins axi_register_slice/aclk]
  ...
  connect_bd_net -net net_zynq_us_ss_soft_reset [get_bd_pins axis_data_fifo_path_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_path_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_tx_path/s_axis_aresetn] [get_bd_pins axis_downconv_path_0/aresetn] [get_bd_pins axis_downconv_path_1/aresetn] [get_bd_pins axis_upconv_path_0/aresetn] [get_bd_pins axis_upconv_path_1/aresetn] [get_bd_pins axis_upconv_tx_path/aresetn] [get_bd_pins colorthresholding_accel/ap_rst_n] [get_bd_pins dfx_decouplers/soft_rst_n] [get_bd_pins filter2d_accel/ap_rst_n] [get_bd_pins gray2rgb_accel/ap_rst_n] [get_bd_pins lut_accel/ap_rst_n] [get_bd_pins duplicate_accel/aresetn] [get_bd_pins pr_0/clk_300MHz_aresetn] [get_bd_pins pr_1/clk_300MHz_aresetn] [get_bd_pins pr_2/clk_300MHz_aresetn] [get_bd_pins ps_user_soft_reset/peripheral_aresetn] [get_bd_pins rgb2gray_accel/ap_rst_n] [get_bd_pins rgb2hsv_accel/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x80130000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_1/erode_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80138000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_1/dilate_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80140000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_2/erode_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80148000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_2/dilate_accel/s_axi_control/Reg] -force
