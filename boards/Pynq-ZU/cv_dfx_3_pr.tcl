...
#                       up to 1080p.
#
# 3.00  mr   04/08/2022 update to 2022.1, use BDC containers for the DFX regions
#
# 3.01  mr   04/11/2022 Move BDC and DFX commands to a separate file
#
# 4.00  mr   05/24/2022 Use 3 DFX regions, move duplicate to the static portion
#
# </pre>
#
###############################################################################
...
proc create_hier_cell_dfx_decouplers { parentCell nameHier } {
  ...
  # Create instance: dfx_decoupler_pr_2
  set dfx_decoupler_pr_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:dfx_decoupler:1.0 dfx_decoupler_pr_2 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_INTERCONNECT_1 [get_bd_intf_pins S13_AXI] [get_bd_intf_pins axi_register_slice/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M03_AXI [get_bd_intf_pins dfx_decoupler_pr_1/rp_axi_lite] [get_bd_intf_pins axi_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M04_AXI [get_bd_intf_pins dfx_decoupler_pr_2/rp_axi_lite] [get_bd_intf_pins axi_interconnect/M02_AXI]
...
proc create_hier_cell_mipi { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst clk_200MHz_aresetn
  ...
  # Create instance: axis_fifo_m2c_cdc, and set properties
  set axis_fifo_m2c_cdc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_fifo_m2c_cdc ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.HAS_TSTRB {0} \
  ...
  # Create instance: axis_fifo_c2m_cdc, and set properties
  set axis_fifo_c2m_cdc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_fifo_c2m_cdc ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.HAS_TSTRB {0} \
  ...
  connect_bd_intf_net -intf_net net_camgpio [get_bd_intf_pins cam_gpio] [get_bd_intf_pins gpio_ip_reset/GPIO2]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M05_AXI [get_bd_intf_pins axi_interconnect_1/M05_AXI] [get_bd_intf_pins pixel_pack/s_axi_control]
  ...
  connect_bd_intf_net -intf_net axis_channel_swap_M_AXIS [get_bd_intf_pins axis_channel_swap/M_AXIS] [get_bd_intf_pins axis_fifo_m2c_cdc/S_AXIS]
  connect_bd_intf_net -intf_net axis_fifo_m2c_cdc_M_AXIS [get_bd_intf_pins axis_fifo_m2c_cdc/M_AXIS] [get_bd_intf_pins axis_dwidth_48_24/S_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_24_48_M_AXIS [get_bd_intf_pins axis_dwidth_24_48/M_AXIS] [get_bd_intf_pins axis_fifo_c2m_cdc/S_AXIS]
  connect_bd_intf_net -intf_net axis_fifo_c2m_cdc_M_AXIS [get_bd_intf_pins axis_fifo_c2m_cdc/M_AXIS] [get_bd_intf_pins pixel_pack/stream_in_48]
  ...
  connect_bd_intf_net -intf_net mipi_phy_if_1 [get_bd_intf_pins mipi_phy_if] [get_bd_intf_pins mipi_csi2_rx_subsyst/mipi_phy_if]
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_ip_reset_gpio_io_o [get_bd_pins gpio_ip_reset/gpio_io_o] [get_bd_pins soft_reset/aux_reset_in]
  connect_bd_net -net soft_peripheral_aresetn [get_bd_pins soft_reset/peripheral_aresetn] [get_bd_pins axis_channel_swap/aresetn] [get_bd_pins demosaic/ap_rst_n] [get_bd_pins gamma_lut/ap_rst_n] [get_bd_pins pixel_pack/ap_rst_n] [get_bd_pins v_proc_sys/aresetn] [get_bd_pins axis_fifo_m2c_cdc/s_axis_aresetn]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins s2mm_introut] [get_bd_pins axi_vdma/s2mm_introut]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_200MHz] [get_bd_pins mipi_csi2_rx_subsyst/dphy_clk_200M] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/M03_ACLK] [get_bd_pins axi_interconnect_1/M04_ACLK] [get_bd_pins axi_interconnect_1/M05_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_vdma/m_axi_s2mm_aclk] [get_bd_pins axi_vdma/s_axis_s2mm_aclk] [get_bd_pins axis_channel_swap/aclk] [get_bd_pins axis_subset_converter/aclk] [get_bd_pins demosaic/ap_clk] [get_bd_pins gamma_lut/ap_clk] [get_bd_pins gpio_ip_reset/s_axi_aclk] [get_bd_pins mipi_csi2_rx_subsyst/video_aclk] [get_bd_pins pixel_pack/ap_clk] [get_bd_pins v_proc_sys/aclk] [get_bd_pins soft_reset/slowest_sync_clk] [get_bd_pins axis_fifo_m2c_cdc/s_axis_aclk] [get_bd_pins axis_fifo_c2m_cdc/m_axis_aclk]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked [get_bd_pins clk_200MHz_aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/M03_ARESETN] [get_bd_pins axi_interconnect_1/M04_ARESETN] [get_bd_pins axi_interconnect_1/M05_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axis_subset_converter/aresetn] [get_bd_pins gpio_ip_reset/s_axi_aresetn] [get_bd_pins mipi_csi2_rx_subsyst/video_aresetn] [get_bd_pins soft_reset/ext_reset_in]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins clk_100MHz_aresetn] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M06_ARESETN] [get_bd_pins axi_vdma/axi_resetn] [get_bd_pins mipi_csi2_rx_subsyst/lite_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins clk_100MHz] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M06_ACLK] [get_bd_pins axi_vdma/s_axi_lite_aclk] [get_bd_pins mipi_csi2_rx_subsyst/lite_aclk]
  connect_bd_net -net net_zynq_aresetn_300 [get_bd_pins clk_300MHz_aresetn] [get_bd_pins axis_fifo_c2m_cdc/s_axis_aresetn] [get_bd_pins axis_dwidth_48_24/aresetn] [get_bd_pins axis_dwidth_24_48/aresetn]
  connect_bd_net -net net_zynq_300 [get_bd_pins clk_300MHz] [get_bd_pins axis_dwidth_24_48/aclk] [get_bd_pins axis_fifo_c2m_cdc/s_axis_aclk] [get_bd_pins axis_fifo_m2c_cdc/m_axis_aclk] [get_bd_pins axis_dwidth_48_24/aclk]
...
proc create_hier_cell_composable { parentCell nameHier } {
  ...
  # Create instance: axis_data_fifo_path_0, and set properties
  set axis_data_fifo_path_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_path_0 ]
  set_property -dict [ list \
   ...
   CONFIG.TID_WIDTH {0} \
   CONFIG.TUSER_WIDTH {1} \
 ] $axis_data_fifo_path_0

  # Create instance: axis_data_fifo_path_1, and set properties
  set axis_data_fifo_path_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_path_1 ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {16384} \
   CONFIG.FIFO_MEMORY_TYPE {ultra} \
   CONFIG.HAS_TKEEP {0} \
  ...
  set axis_downconv_path_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_downconv_path_0 ]
  set_property -dict [ list \
  ...
  set axis_downconv_path_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_downconv_path_1 ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {0} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  set axis_upconv_path_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_upconv_path_0 ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {1} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  set axis_upconv_path_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_upconv_path_1 ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {1} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  # Create instance: pipeline_control, and set properties
  set const_axis_dfx_pr_2_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 const_axis_dfx_pr_2_1 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
 ] $const_axis_dfx_pr_2_1
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_path_0_M_AXIS [get_bd_intf_pins axis_data_fifo_path_0/M_AXIS] [get_bd_intf_pins axis_downconv_path_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_path_1_M_AXIS [get_bd_intf_pins axis_data_fifo_path_1/M_AXIS] [get_bd_intf_pins axis_downconv_path_1/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_downconv_path_0_M_AXIS [get_bd_intf_pins axis_downconv_path_0/M_AXIS] [get_bd_intf_pins axis_switch/S09_AXIS]
  connect_bd_intf_net -intf_net axis_downconv_path_1_M_AXIS [get_bd_intf_pins axis_downconv_path_1/M_AXIS] [get_bd_intf_pins axis_switch/S10_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_1_M_AXIS [get_bd_intf_pins axis_data_fifo_path_0/S_AXIS] [get_bd_intf_pins axis_upconv_path_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_2_M_AXIS [get_bd_intf_pins axis_data_fifo_path_1/S_AXIS] [get_bd_intf_pins axis_upconv_path_1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_switch_M09_AXIS [get_bd_intf_pins axis_switch/M09_AXIS] [get_bd_intf_pins duplicate_accel/stream_in]
  connect_bd_intf_net -intf_net axis_switch_M10_AXIS [get_bd_intf_pins axis_switch/M10_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_0_0]
  connect_bd_intf_net -intf_net axis_switch_M11_AXIS [get_bd_intf_pins axis_switch/M11_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_0_1]
  connect_bd_intf_net -intf_net axis_switch_M12_AXIS [get_bd_intf_pins axis_switch/M12_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_1_0]
  connect_bd_intf_net -intf_net axis_switch_M13_AXIS [get_bd_intf_pins axis_switch/M13_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_1_1]
  connect_bd_intf_net -intf_net axis_switch_M14_AXIS [get_bd_intf_pins axis_switch/M14_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_2_0]
  connect_bd_intf_net -intf_net axis_switch_M15_AXIS [get_bd_intf_pins axis_switch/M15_AXIS] [get_bd_intf_pins dfx_decouplers/s_axis_dfx_pr_2_1]
  ...
  connect_bd_intf_net -intf_net dfx_decouplers_m_axis_dfx_pr_0_0 [get_bd_intf_pins axis_switch/S11_AXIS] [get_bd_intf_pins dfx_decouplers/m_axis_dfx_pr_0_0]
  connect_bd_intf_net -intf_net dfx_decouplers_m_axis_dfx_pr_0_1 [get_bd_intf_pins axis_switch/S12_AXIS] [get_bd_intf_pins dfx_decouplers/m_axis_dfx_pr_0_1]
  connect_bd_intf_net -intf_net dfx_decouplers_m_axis_dfx_pr_1_0 [get_bd_intf_pins axis_switch/S13_AXIS] [get_bd_intf_pins dfx_decouplers/m_axis_dfx_pr_1_0]
  connect_bd_intf_net -intf_net dfx_decouplers_m_axis_dfx_pr_1_1 [get_bd_intf_pins axis_switch/S14_AXIS] [get_bd_intf_pins dfx_decouplers/m_axis_dfx_pr_1_1]
  connect_bd_intf_net -intf_net dfx_decouplers_m_axis_dfx_pr_2_0 [get_bd_intf_pins axis_switch/S15_AXIS] [get_bd_intf_pins dfx_decouplers/m_axis_dfx_pr_2_0]
  ...
  connect_bd_intf_net -intf_net duplicate_accel_stream_out0 [get_bd_intf_pins axis_upconv_path_0/S_AXIS] [get_bd_intf_pins duplicate_accel/stream_out]
  connect_bd_intf_net -intf_net duplicate_accel_stream_out1 [get_bd_intf_pins axis_upconv_path_1/S_AXIS] [get_bd_intf_pins duplicate_accel/stream_out1]
  ...
  connect_bd_intf_net -intf_net pr_2_stream_out0 [get_bd_intf_pins dfx_decouplers/s_axis_pr_2_0] [get_bd_intf_pins pr_2/stream_out0]
  connect_bd_intf_net -intf_net pr_2_stream_out1 [get_bd_intf_pins dfx_decouplers/s_axis_pr_2_1] [get_bd_intf_pins pr_2/stream_out1]
  ...
  connect_bd_intf_net -intf_net s_axi_control_1 [get_bd_intf_pins dfx_decouplers/s_axi_pr_2] [get_bd_intf_pins pr_2/s_axi_control]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins duplicate_accel/s_axi_control] [get_bd_intf_pins smartconnect/M05_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M06_AXI [get_bd_intf_pins colorthresholding_accel/s_axi_control] [get_bd_intf_pins smartconnect/M06_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M07_AXI [get_bd_intf_pins pipeline_control/S_AXI] [get_bd_intf_pins smartconnect/M07_AXI]
  connect_bd_intf_net -intf_net stream_in0_1 [get_bd_intf_pins dfx_decouplers/m_axis_pr_2_0] [get_bd_intf_pins pr_2/stream_in0]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins clk_300MHz] [get_bd_pins axis_data_fifo_path_0/s_axis_aclk] [get_bd_pins axis_data_fifo_path_1/s_axis_aclk] [get_bd_pins axis_data_fifo_tx_path/s_axis_aclk] [get_bd_pins axis_downconv_path_0/aclk] [get_bd_pins axis_downconv_path_1/aclk] [get_bd_pins axis_switch/aclk] [get_bd_pins axis_switch/s_axi_ctrl_aclk] [get_bd_pins axis_upconv_path_0/aclk] [get_bd_pins axis_upconv_path_1/aclk] [get_bd_pins axis_upconv_tx_path/aclk] [get_bd_pins colorthresholding_accel/ap_clk] [get_bd_pins dfx_decouplers/clk_300MHz] [get_bd_pins filter2d_accel/ap_clk] [get_bd_pins gray2rgb_accel/ap_clk] [get_bd_pins lut_accel/ap_clk] [get_bd_pins duplicate_accel/ap_clk] [get_bd_pins pipeline_control/s_axi_aclk] [get_bd_pins pr_0/clk_300MHz] [get_bd_pins pr_1/clk_300MHz] [get_bd_pins pr_2/clk_300MHz] [get_bd_pins ps_user_soft_reset/slowest_sync_clk] [get_bd_pins rgb2gray_accel/ap_clk] [get_bd_pins rgb2hsv_accel/ap_clk] [get_bd_pins smartconnect/aclk] [get_bd_pins axi_register_slice/aclk]
  ...
  connect_bd_net -net net_zynq_us_ss_soft_reset [get_bd_pins axis_data_fifo_path_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_path_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_tx_path/s_axis_aresetn] [get_bd_pins axis_downconv_path_0/aresetn] [get_bd_pins axis_downconv_path_1/aresetn] [get_bd_pins axis_upconv_path_0/aresetn] [get_bd_pins axis_upconv_path_1/aresetn] [get_bd_pins axis_upconv_tx_path/aresetn] [get_bd_pins colorthresholding_accel/ap_rst_n] [get_bd_pins dfx_decouplers/soft_rst_n] [get_bd_pins filter2d_accel/ap_rst_n] [get_bd_pins gray2rgb_accel/ap_rst_n] [get_bd_pins lut_accel/ap_rst_n] [get_bd_pins duplicate_accel/ap_rst_n] [get_bd_pins pr_0/clk_300MHz_aresetn] [get_bd_pins pr_1/clk_300MHz_aresetn] [get_bd_pins pr_2/clk_300MHz_aresetn] [get_bd_pins ps_user_soft_reset/peripheral_aresetn] [get_bd_pins rgb2gray_accel/ap_rst_n] [get_bd_pins rgb2hsv_accel/ap_rst_n]
  ...
  connect_bd_net [get_bd_pins const_axis_dfx_pr_2_1/dout] [get_bd_pins dfx_decouplers/m_axis_dfx_pr_2_1_tready]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins main_axi_interconnect/M12_AXI] [get_bd_intf_pins mipi/S_AXI_INTERCONNECT]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M02_AXI [get_bd_intf_pins HDMI_CTL_axi_iic/S_AXI] [get_bd_intf_pins main_axi_interconnect/M02_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M03_AXI [get_bd_intf_pins main_axi_interconnect/M03_AXI] [get_bd_intf_pins shutdown_HP1_FPD/S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_interconnect_M04_AXI [get_bd_intf_pins axi_intc/s_axi] [get_bd_intf_pins main_axi_interconnect/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M05_AXI [get_bd_intf_pins main_axi_interconnect/M05_AXI] [get_bd_intf_pins leds_gpio/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M06_AXI [get_bd_intf_pins main_axi_interconnect/M06_AXI] [get_bd_intf_pins hdmi_tx_control/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M07_AXI [get_bd_intf_pins main_axi_interconnect/M07_AXI] [get_bd_intf_pins shutdown_HP2_FPD/S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_interconnect_M08_AXI [get_bd_intf_pins main_axi_interconnect/M08_AXI] [get_bd_intf_pins shutdown_HP0_FPD/S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_interconnect_M09_AXI [get_bd_intf_pins main_axi_interconnect/M09_AXI] [get_bd_intf_pins rgbleds/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M10_AXI [get_bd_intf_pins main_axi_interconnect/M10_AXI] [get_bd_intf_pins switches_gpio/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M11_AXI [get_bd_intf_pins main_axi_interconnect/M11_AXI] [get_bd_intf_pins btns_gpio/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M13_AXI [get_bd_intf_pins main_axi_interconnect/M13_AXI] [get_bd_intf_pins composable/S13_AXI]
  ...
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_M00_AXI [get_bd_intf_pins main_axi_interconnect/M00_AXI] [get_bd_intf_pins video/vid_phy_axi4lite]
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_M01_AXI [get_bd_intf_pins main_axi_interconnect/M01_AXI] [get_bd_intf_pins video/S_AXI_INTERCONNECT]
  ...
  connect_bd_intf_net -intf_net mipi_phy_if_1 [get_bd_intf_ports mipi_phy_if] [get_bd_intf_pins mipi/mipi_phy_if]
  ...
  connect_bd_net -net xlconcat_int_dout [get_bd_pins xlconcat_int/dout] [get_bd_pins ps_e/pl_ps_irq0]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins main_axi_interconnect/M07_ACLK] [get_bd_pins main_axi_interconnect/M08_ACLK] [get_bd_pins main_axi_interconnect/M13_ACLK] [get_bd_pins composable/clk_300MHz] [get_bd_pins mipi/clk_300MHz] [get_bd_pins proc_sys_reset_plclk1/slowest_sync_clk] [get_bd_pins ps_e/pl_clk1] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp2_fpd_aclk] [get_bd_pins shutdown_HP0_FPD/clk] [get_bd_pins shutdown_HP2_FPD/clk] [get_bd_pins video/clk_300MHz]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked [get_bd_pins main_axi_interconnect/M07_ARESETN] [get_bd_pins main_axi_interconnect/M08_ARESETN] [get_bd_pins main_axi_interconnect/M13_ARESETN] [get_bd_pins composable/clk_300MHz_aresetn] [get_bd_pins mipi/clk_300MHz_aresetn] [get_bd_pins proc_sys_reset_plclk1/peripheral_aresetn] [get_bd_pins shutdown_HP0_FPD/resetn] [get_bd_pins shutdown_HP2_FPD/resetn] [get_bd_pins video/clk_300MHz_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins HDMI_CTL_axi_iic/s_axi_aresetn] [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins main_axi_interconnect/M00_ARESETN] [get_bd_pins main_axi_interconnect/M01_ARESETN] [get_bd_pins main_axi_interconnect/M02_ARESETN] [get_bd_pins main_axi_interconnect/M04_ARESETN] [get_bd_pins main_axi_interconnect/M05_ARESETN] [get_bd_pins main_axi_interconnect/M06_ARESETN] [get_bd_pins main_axi_interconnect/M09_ARESETN] [get_bd_pins main_axi_interconnect/M10_ARESETN] [get_bd_pins main_axi_interconnect/M11_ARESETN] [get_bd_pins main_axi_interconnect/S00_ARESETN] [get_bd_pins btns_gpio/s_axi_aresetn] [get_bd_pins leds_gpio/s_axi_aresetn] [get_bd_pins mipi/clk_100MHz_aresetn] [get_bd_pins proc_sys_reset_plclk0/peripheral_aresetn] [get_bd_pins rgbleds/s_axi_aresetn] [get_bd_pins switches_gpio/s_axi_aresetn] [get_bd_pins hdmi_tx_control/s_axi_aresetn] [get_bd_pins video/clk_100MHz_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins ps_e/pl_clk0] [get_bd_pins HDMI_CTL_axi_iic/s_axi_aclk] [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins main_axi_interconnect/ACLK] [get_bd_pins main_axi_interconnect/M00_ACLK] [get_bd_pins main_axi_interconnect/M01_ACLK] [get_bd_pins main_axi_interconnect/M02_ACLK] [get_bd_pins main_axi_interconnect/M04_ACLK] [get_bd_pins main_axi_interconnect/M05_ACLK] [get_bd_pins main_axi_interconnect/M06_ACLK] [get_bd_pins main_axi_interconnect/M09_ACLK] [get_bd_pins main_axi_interconnect/M10_ACLK] [get_bd_pins main_axi_interconnect/M11_ACLK] [get_bd_pins main_axi_interconnect/S00_ACLK] [get_bd_pins btns_gpio/s_axi_aclk] [get_bd_pins leds_gpio/s_axi_aclk] [get_bd_pins mipi/clk_100MHz] [get_bd_pins proc_sys_reset_plclk0/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_lpd_aclk] [get_bd_pins rgbleds/s_axi_aclk] [get_bd_pins switches_gpio/s_axi_aclk] [get_bd_pins hdmi_tx_control/s_axi_aclk] [get_bd_pins video/clk_100MHz] [get_bd_pins clk_wiz_200/clk_in1]
  connect_bd_net -net net_proc_sys_reset_aresetn [get_bd_pins proc_sys_reset_plclk2/peripheral_aresetn] [get_bd_pins mipi/clk_200MHz_aresetn] [get_bd_pins shutdown_HP1_FPD/resetn] [get_bd_pins main_axi_interconnect/M03_ARESETN] [get_bd_pins main_axi_interconnect/M12_ARESETN]
  ...
  connect_bd_net -net clk_wiz_200_clk_out1 [get_bd_pins clk_wiz_200/clk_out1] [get_bd_pins mipi/clk_200MHz] [get_bd_pins proc_sys_reset_plclk2/slowest_sync_clk] [get_bd_pins shutdown_HP1_FPD/clk] [get_bd_pins main_axi_interconnect/M03_ACLK] [get_bd_pins main_axi_interconnect/M12_ACLK] [get_bd_pins ps_e/saxihp1_fpd_aclk]

  # Create address segments
  assign_bd_address -offset 0x80041000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs HDMI_CTL_axi_iic/S_AXI/Reg] -force
  assign_bd_address -offset 0x80010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs video/hdmi_out/color_convert/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs video/hdmi_in/frontend/S_AXI_CPU_IN/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs video/hdmi_out/frontend/S_AXI_CPU_IN/Reg] -force
  ...
  assign_bd_address -offset 0x80060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs video/phy/vid_phy_controller/vid_phy_axi4lite/Reg] -force
  assign_bd_address -offset 0x80070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs video/hdmi_in/pixel_pack/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs video/hdmi_out/pixel_unpack/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80050000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs video/hdmi_in/color_convert/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x80210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs mipi/demosaic/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x80220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs mipi/gamma_lut/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x80230000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs mipi/gpio_ip_reset/S_AXI/Reg] -force
  assign_bd_address -offset 0x80244000 -range 0x00002000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs mipi/mipi_csi2_rx_subsyst/csirxss_s_axi/Reg] -force
  ...
  assign_bd_address -offset 0x80140000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_1/erode_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80148000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_1/dilate_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80150000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_2/erode_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80158000 -range 0x00008000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs composable/pr_2/dilate_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80011000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs btns_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x80046000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs leds_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x80012000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs rgbleds/S_AXI/Reg] -force
  assign_bd_address -offset 0x80040000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs switches_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x801A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs shutdown_HP0_FPD/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0x801B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs shutdown_HP1_FPD/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0x801C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs shutdown_HP2_FPD/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0x80016000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs hdmi_tx_control/S_AXI/Reg] -force
