...
proc create_hier_cell_composable { parentCell nameHier } {
  ...
  connect_bd_net -net soft_peripheral_aresetn [get_bd_pins axis_dwidth_24_48/aresetn] [get_bd_pins axis_dwidth_48_24/aresetn] [get_bd_pins axis_fifo_hdmi_out/s_axis_aresetn] [get_bd_pins fifo_path_0/s_axis_aresetn] [get_bd_pins fifo_path_1/s_axis_aresetn] [get_bd_pins colorthresholding_accel/ap_rst_n] [get_bd_pins dfx_decouplers/periph_resetn_clk142M] [get_bd_pins filter2d_accel/ap_rst_n] [get_bd_pins gray2rgb_accel/ap_rst_n] [get_bd_pins lut_accel/ap_rst_n] [get_bd_pins duplicate_accel/aresetn] [get_bd_pins pr_0/periph_resetn_clk142M] [get_bd_pins pr_1/periph_resetn_clk142M] [get_bd_pins pr_2/periph_resetn_clk142M] [get_bd_pins ps_user_soft_reset/peripheral_aresetn] [get_bd_pins rgb2gray_accel/ap_rst_n] [get_bd_pins rgb2hsv_accel/ap_rst_n] [get_bd_pins axis_downconv_path_0/aresetn] [get_bd_pins axis_upconv_path_0/aresetn] [get_bd_pins axis_downconv_path_1/aresetn] [get_bd_pins axis_upconv_path_1/aresetn]
