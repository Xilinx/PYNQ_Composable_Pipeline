...
proc create_hier_cell_dfx_decouplers { parentCell nameHier } {
  ...
  # Create instance: pr_2_out0, and set properties
  set pr_2_out0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 pr_2_out0 ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
   CONFIG.HAS_TSTRB {0} \
  ...
  connect_bd_intf_net -intf_net pr_2_out0_M_AXIS [get_bd_intf_pins dfx_decoupler_pr_2/rp_out_0] [get_bd_intf_pins pr_2_out0/M_AXIS]
  connect_bd_intf_net -intf_net pr_2_stream_out1 [get_bd_intf_pins s_axis_pr_2_0] [get_bd_intf_pins pr_2_out0/S_AXIS]
  connect_bd_intf_net -intf_net pr_2_stream_out0 [get_bd_intf_pins s_axis_pr_2_1] [get_bd_intf_pins dfx_decoupler_pr_2/rp_out_1]
  ...
  connect_bd_net -net peripheral_aresetn [get_bd_pins periph_resetn_clk142M] [get_bd_pins pr_0_out0/aresetn] [get_bd_pins pr_0_out1/aresetn] [get_bd_pins pr_1_out0/aresetn] [get_bd_pins pr_1_out1/aresetn] [get_bd_pins pr_2_out0/aresetn]
  connect_bd_net -net ps7_0_FCLK_CLK1 [get_bd_pins clk_142M] [get_bd_pins pr_0_out0/aclk] [get_bd_pins pr_0_out1/aclk] [get_bd_pins pr_1_out0/aclk] [get_bd_pins pr_1_out1/aclk] [get_bd_pins pr_2_out0/aclk]
...
proc create_hier_cell_composable { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net fifo_path_0_m_axis [get_bd_intf_pins axis_switch/S07_AXIS] [get_bd_intf_pins fifo_path_0/M_AXIS]
  connect_bd_intf_net -intf_net fifo_path_1_m_axis [get_bd_intf_pins axis_switch/S08_AXIS] [get_bd_intf_pins fifo_path_1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net duplicate_accel_stream_out0 [get_bd_intf_pins fifo_path_0/S_AXIS] [get_bd_intf_pins duplicate_accel/stream_out]
  connect_bd_intf_net -intf_net duplicate_accel_stream_out1 [get_bd_intf_pins fifo_path_1/S_AXIS] [get_bd_intf_pins duplicate_accel/stream_out1]
  ...
  #connect_bd_intf_net -intf_net pr_fork_in0_M_AXIS [get_bd_intf_pins dfx_decouplers/m_axis_pr_fork] [get_bd_intf_pins pr_fork/stream_in]
  ...
  connect_bd_net -net soft_peripheral_aresetn [get_bd_pins axis_dwidth_24_48/aresetn] [get_bd_pins axis_dwidth_48_24/aresetn] [get_bd_pins axis_fifo_hdmi_out/s_axis_aresetn] [get_bd_pins fifo_path_0/s_axis_aresetn] [get_bd_pins fifo_path_1/s_axis_aresetn] [get_bd_pins colorthresholding_accel/ap_rst_n] [get_bd_pins dfx_decouplers/periph_resetn_clk142M] [get_bd_pins filter2d_accel/ap_rst_n] [get_bd_pins gray2rgb_accel/ap_rst_n] [get_bd_pins lut_accel/ap_rst_n] [get_bd_pins duplicate_accel/ap_rst_n] [get_bd_pins pr_0/periph_resetn_clk142M] [get_bd_pins pr_1/periph_resetn_clk142M] [get_bd_pins pr_fork/periph_resetn_clk142M] [get_bd_pins pr_2/periph_resetn_clk142M] [get_bd_pins ps_user_soft_reset/peripheral_aresetn] [get_bd_pins rgb2gray_accel/ap_rst_n] [get_bd_pins rgb2hsv_accel/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x400A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs composable/duplicate_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs composable/filter2d_accel/s_axi_control/Reg] -force
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs composable/gray2rgb_accel/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x40040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs composable/lut_accel/s_axi_control/Reg] -force
