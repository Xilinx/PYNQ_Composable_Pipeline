...
//https://xilinx.github.io/Vitis_Libraries/vision/2020.2/api-reference.html#xf-cv-absdiff
void absdiff_accel(stream_t& stream_in, 
                   stream_t& stream_in1, 
                   stream_t& stream_out, 
                   unsigned int rows,
                   unsigned int cols)
...
#pragma HLS DATAFLOW
    ...
    // Run xfOpenCV kernel:
    xf::cv::absdiff<INTYPE, HEIGHT, WIDTH, NPIX>(img_in0, img_in1, img_out);
