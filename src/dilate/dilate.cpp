...
//https://docs.xilinx.com/r/en-US/Vitis_Libraries/vision/api-reference.html_2_36
void dilate_accel(stream_t& stream_in, 
                  stream_t& stream_out, 
...
#pragma HLS DATAFLOW
    ...
    // Run xfOpenCV kernel:
    xf::cv::dilate<XF_BORDER_CONSTANT, INTYPE, HEIGHT, WIDTH, XF_SHAPE_CROSS, KERNEL_SIZE, KERNEL_SIZE, ITERATIONS, NPIX>(
