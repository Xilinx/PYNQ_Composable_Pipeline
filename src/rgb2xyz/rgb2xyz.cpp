...
// https://xilinx.github.io/Vitis_Libraries/vision/2020.2/api-reference.html#rgb-to-xyz
void rgb2xyz_accel(stream_t& stream_in, 
                    stream_t& stream_out,
                    unsigned int rows,
                    unsigned int cols)
{
...
#pragma HLS DATAFLOW
    ...
    // Run xfOpenCV kernel:
    xf::cv::rgb2xyz<INTYPE, INTYPE, HEIGHT, WIDTH, NPIX>(img_in, img_out);
